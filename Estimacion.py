...
if __name__ == "__main__":
    nombre_archivo_ply = r"C:\Users\carlo\Documents\pruebas alturas\70cm 20grados.ply"
    pcd = cargar_ply(nombre_archivo_ply)
    # Filtrado de puntos
    pcd_filtrado = filtrar_puntos(pcd, z_min=-1, z_max=1)  # Puedes ajustar estos valores según tus datos
    ...
    print(f"Nombre del archivo: {nombre_archivo_ply})")
